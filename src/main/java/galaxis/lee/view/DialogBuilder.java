...
public class DialogBuilder {
    ...
    public static void alert(Control control, String info) {
        ...
        new DialogBuilder(control).setPositiveBtn("确定", new OnClickListener() {
            @Override
            public void onClick() {
                //点击确定按钮之后执行的动作
                // new DialogBuilder(control).setTitle("提示").setMessage("点击确定“"+info+"”之后执行的动作").setNegativeBtn("确定").create();
    ...
    public static boolean alertChoose(Control control, String info) {
        new DialogBuilder(control).setNegativeBtn("取消", new OnClickListener() {
            @Override
            public void onClick() {
                flag = false;
                //点击取消按钮之后执行的动作
