...
/**
 * @Author: Lee
 * @Date: Created in 16:09 2020/8/7
 * @Description: TODO 开启线程发送执行命令
 */
public class ActionThreadPool {
    ...
    public ActionThreadPool(int workerNumber) {
    ...
    public static void main(String[] args) {
        ActionThreadPool threadPool = new ActionThreadPool(1);
        ...
        threadPool.execute(new Thread(new Runnable() {
            ...
            public void run() {
                ...
                System.out.println("time pay:" + (now - start));
                try {
                    Thread.sleep(1000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
