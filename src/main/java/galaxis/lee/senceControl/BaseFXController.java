...
public abstract class BaseFXController extends AbstractFxmlView implements Initializable {
    ...
    private static Map<FXMLPages, SoftReference<? extends BaseFXController>> cacheNodeMap = new HashMap<>();

    public BaseFXController loadFXMLPage(String title, FXMLPages fxmlPage, boolean cache) {
